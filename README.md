...
6. Add the first feature - Current Round Stats - and commit it
    - Copy the code from the `index.html` in the `app-stages/stage-1` to the current `index.html` in your `start` directory
...
8. Add the third an final feature - Round Results Styling
    - Copy the code from the `script.js` in the `app-stages/stage-3` to the current `script.js` in your `start` directory
    - Add and commit the changes
```bash
git add .
