...
2. [Notes](#notes)
3. [Initial Set Up Steps for the Base Environment](#initial-set-up-steps-for-the-base-environment)
...
- When prompted for <full-file-path-to-start> in the 4 different git ops sections, you can find this by _right-clicking_ on your `start` folder in your IDE and choosing "Copy Path". You want the full path here.
